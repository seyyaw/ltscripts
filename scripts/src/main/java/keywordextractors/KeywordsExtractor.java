...
public class KeywordsExtractor {
    ...
    public static void main(String[] args) throws IOException {
    	String text = "The long man who scavenger every action seems to work very well despite the unpridicted lazy ness of him";
    	List<CardKeyword> keywordsList = KeywordsExtractor.getKeywordsList(text);
    
		for(CardKeyword k:keywordsList){
    		System.out.println(k.getTerms() + "="+k.getFrequency());
    	}
